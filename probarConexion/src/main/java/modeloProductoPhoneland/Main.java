...
public class Main {
	public static void main(String[] args) {
        String dbURL = "jdbc:mysql://localhost/phonelandcompleta2"; // URL de la base de datos
        String dbUser = "root"; // Usuario de la base de datos
        String dbPassword = ""; // Contraseña del usuario

        try {
            ProdPhonelandController controller = new ProdPhonelandController(dbURL, dbUser, dbPassword); // Crea una instancia del controlador
